"""
Traffic Prediction using LSTM (TensorFlow/Keras)
=================================================
...
MODEL_SAVE_PATH   = MODEL_CONFIGS['LSTM']['model_path']
SCALER_SAVE_PATH  = MODEL_CONFIGS['LSTM']['scaler_path']
ENCODER_SAVE_PATH = MODEL_CONFIGS['LSTM']['encoder_path']
...
def plot_results(y_actual, y_pred, title='LSTM Predictions vs Actual'):
    ...
    plt.show()
    print(" Plot saved to models/lstm_predictions.png")
...
def train_and_save() -> tuple:
    ...
    and with the other two architectures (RNN.py / GRU.py).
    """
