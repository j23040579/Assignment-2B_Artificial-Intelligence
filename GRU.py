"""
Traffic Prediction using GRU (TensorFlow/Keras)
================================================
...
MODEL_SAVE_PATH   = MODEL_CONFIGS['GRU']['model_path']
SCALER_SAVE_PATH  = MODEL_CONFIGS['GRU']['scaler_path']
ENCODER_SAVE_PATH = MODEL_CONFIGS['GRU']['encoder_path']
...
def train_and_save() -> tuple:
    ...
    and with the other two architectures (RNN.py / LSTM.py).
    """
